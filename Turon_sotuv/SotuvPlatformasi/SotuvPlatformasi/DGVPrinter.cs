...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            titlefont = new Font("Tahoma", 14, FontStyle.Bold, GraphicsUnit.Point);
        ...
        void SetupPrint()
        {
            if (EnableLogging)
            {
                ...
                Logger.LogInfoMsg(String.Format("Initial Printer Margins are {0}, {1}, {2}, {3}",  m.Top, m.Bottom, m.Left, m.Right));
            }
